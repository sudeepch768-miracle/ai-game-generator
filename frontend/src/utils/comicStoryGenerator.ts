    ...
    panels: [
      {
        ...
        thoughtMonologue: "They thought this bio-lab was buried deep enough that no one would ever find it. They didn't count on me.",
        ...
        sfxColor: '#00f2fe',
        dialogues: [
          { speaker: 'hero', speakerName: 'AGENT ZERO', avatar: '🕵️‍♂️', text: "Emergency codes verified. Time to find the antidote cipher and break this facility wide open.", tailPosition: 'left', emotion: 'determined' },
          { speaker: 'ally', speakerName: 'HQ COMMS', avatar: '📻', text: 'Zero, the Chief Inspector just mobilized the quarantine drones! Move softly!', tailPosition: 'right' },
        ],
        captionCards: [
          { text: "EVEN THOUGH THE TRIAGE PROTOCOLS BRANDED ME A TRESPASSER,", position: 'top-left' },
          { text: "SHE GAVE HER LIFE TO HAND ME THE BIO-CIPHER...", position: 'middle-right' },
          { text: "...AND PROVED THAT ONE PERSON CAN EXPOSE A CONSPIRACY.", position: 'middle-right' },
        ],
      },
      {
        panelNumber: 2,
        title: 'THE CRASH & ALARM',
        narrationBox: 'RED ALARM SIRENS PIERCE THE BIO-WING! CONTAINMENT IS COMPROMISED!',
        thoughtMonologue: "The sirens are blaring red across the ward. Patrol drones converging. No backup. Just like every Monday.",
        ...
        sfxColor: '#ff003c',
        dialogues: [
          { speaker: 'boss', speakerName: boss, avatar: '👨‍⚕️', text: 'LOCKDOWN ALL CORRIDORS! Deploy the containment enforcers! No one leaves this lab alive!', tailPosition: 'right', emotion: 'angry' },
          { speaker: 'hero', speakerName: 'AGENT ZERO', avatar: '😎', text: "You'll have to catch me first, Inspector. And I'm taking the express route.", tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "I SWORE TO TEAR THIS BLACK-SITE FACILITY APART.", position: 'top-left' },
          { text: "FROM THE CORRUPT DIRECTORS, THE ENFORCERS, AND THE VIRAL CAGES...", position: 'middle-left' },
          { text: "I SWORE NO INNOCENT PATIENT WOULD SUFFER IN THE DARK.", position: 'bottom-right' },
        ],
      },
      {
        panelNumber: 3,
        ...
        thoughtMonologue: "Blast doors dropping. Motion lasers arming. Just me, my dash boots, and the mission. Time for a leap of faith.",
        ...
        sfxColor: '#00f2fe',
        dialogues: [
          { speaker: 'ally', speakerName: 'HQ COMMS', avatar: '📻', text: 'Zero! The ambulance bay blast gate is dropping in sixty seconds! Run!', tailPosition: 'right', emotion: 'worried' },
          { speaker: 'hero', speakerName: 'AGENT ZERO', avatar: '😎', text: "Tell the extraction pilot to run hot. I'm leaping through!", tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "HYDRAULIC BLAST GATES SEALING CORRIDOR B! NO RETREAT.", position: 'top-left' },
          { text: "HQ: THE AMBULANCE BAY IS 200 METERS AHEAD. RUN!", speaker: "HQ COMMS", position: 'middle-right' },
          { text: "TELL EXTRACTION TO RUN HOT. I'M LEAPING OUT!", speaker: "AGENT ZERO", position: 'bottom-right' },
        ],
      },
    ],
  };
...
function generateSnowStory(title: string, boss: string): ComicStory {
  return {
    title: 'THE GLACIER EXTRACTION',
    subtitle: `HOW YOU WERE STRANDED IN ${title.toUpperCase()}`,
    theme: 'snow',
    universeTag: 'EARTH-FROST-0',
    heroCodename: 'ARCTIC RANGER',
    panels: [
      {
        panelNumber: 1,
        title: 'SUB-ZERO AMBUSH',
        narrationBox: 'SECTOR GLACIER PASS • MINUS 40°C • BLINDING WHITE-OUT',
        thoughtMonologue: "Engines frozen. Comms severed. The frost titan's pack has our scent across the ridge.",
        freezeFrameBadge: 'ARCTIC RANGER • EXPEDITION LEAD',
        sceneEmoji: '🏔️ ❄️ ⛏️',
        sceneDescription: 'Hammering titanium ice axes into the sheer glacier face under the aurora...',
        bgGradient: 'linear-gradient(135deg, #0c1c2e 0%, #020710 100%)',
        accentColor: '#38bdf8',
        soundEffect: '❄️ *CRACK-SHINK!*',
        sfxColor: '#7dd3fc',
        dialogues: [
          { speaker: 'hero', speakerName: 'ARCTIC RANGER', avatar: '🧗', text: 'Axes locked into the ice shelf. We have ten minutes before the storm drops to minus fifty.', tailPosition: 'left', emotion: 'determined' },
          { speaker: 'ally', speakerName: 'SURVIVAL RADIO', avatar: '📻', text: 'Ranger! Cyber-wolf thermal spikes detected 50 meters behind you!', tailPosition: 'right' },
        ],
        captionCards: [
          { text: "EVEN THOUGH THE SUB-ZERO BLIZZARD CUT US OFF FROM THE WORLD,", position: 'top-left' },
          { text: "THE APEX PREDATOR PACK CLOSED IN ACROSS THE JAGGED ICE...", position: 'middle-right' },
          { text: "...AND HOW I MUST SCALE THE GLACIER WALL BEFORE HYPOTHERMIA HITS.", position: 'middle-right' },
        ],
      },
      {
        panelNumber: 2,
        title: 'THE FLARE STANDOFF',
        narrationBox: 'A ROAR SHATTERS THE ICE SPIRES! THE APEX PACK CONVERGES!',
        thoughtMonologue: "The flare is burning red against the whiteout. One spark between me and the frozen dark.",
        freezeFrameBadge: 'PREDATOR PACK ALERT',
        sceneEmoji: '🔥 🐺 ❄️',
        sceneDescription: 'Sputtering magnesium flare illuminates the cybernetic frost wolves prowling the ridge!',
        bgGradient: 'linear-gradient(135deg, #1e3a5f 0%, #071220 100%)',
        accentColor: '#ef4444',
        soundEffect: '🔥 *FSSSHHHH-ROAR!*',
        sfxColor: '#f87171',
        dialogues: [
          { speaker: 'boss', speakerName: boss, avatar: '🐺', text: 'NO WARMTH SURVIVES IN THIS VALLEY! TEAR THEM DOWN!', tailPosition: 'right', emotion: 'angry' },
          { speaker: 'hero', speakerName: 'ARCTIC RANGER', avatar: '🔥', text: 'Back off! This flare burns at two thousand degrees!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "I SWORE TO SURVIVE THIS FROZEN VALLEY AND LEAD MY SQUAD HOME.", position: 'top-left' },
          { text: "FROM THE PROWLING BEASTS, THE CREVASSES, AND THE AVALANCHES...", position: 'middle-left' },
          { text: "I SWORE NO COMRADE WOULD FREEZE ALONE IN THE WHITE-OUT.", position: 'bottom-right' },
        ],
      },
      {
        panelNumber: 3,
        title: 'THE EXTRACTION DASH',
        narrationBox: 'THE RESCUE HELICOPTER LIGHTS SWEEP THE SUMMIT RIDGE!',
        thoughtMonologue: "Ninety seconds of fuel left on the extraction bird. Crampons locked. Time for a leap of faith.",
        freezeFrameBadge: 'MISSION OBJECTIVE: REACH SUMMIT BEACON',
        sceneEmoji: '🚁 🏃‍♂️ ⚡',
        sceneDescription: 'Sprinting across the icy suspension ridge toward the extraction beacon!',
        bgGradient: 'linear-gradient(135deg, #07192c 0%, #01060e 100%)',
        accentColor: '#38bdf8',
        soundEffect: '💨 *SWOOOOOSH!*',
        sfxColor: '#38bdf8',
        dialogues: [
          { speaker: 'ally', speakerName: 'PILOT VANCE', avatar: '🚁', text: 'Ranger! The blizzard is peaking! Grab the landing skid NOW!', tailPosition: 'right' },
          { speaker: 'hero', speakerName: 'ARCTIC RANGER', avatar: '🏃', text: 'Keep the rotors turning! I am launching across the gap!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "NINETY SECONDS BEFORE THE HELO RUNS DRY. NO SECOND CHANCES.", position: 'top-left' },
          { text: "PILOT: ROTORS ARE ICING OVER! GRAB THE LANDING SKID NOW!", speaker: "PILOT VANCE", position: 'middle-right' },
          { text: "KEEP THE BLADES HOT, VANCE! I'M LEAPING ACROSS THE CREVASSE!", speaker: "ARCTIC RANGER", position: 'bottom-right' },
        ],
      },
    ],
  };
...
function generateHauntedStory(title: string, boss: string): ComicStory {
  return {
    title: 'THE CRYPT SANCTUARY',
    subtitle: `HOW YOU ENTERED ${title.toUpperCase()}`,
    theme: 'haunted',
    universeTag: 'EARTH-CRYPT-13',
    heroCodename: 'OCCULT DETECTIVE',
    panels: [
      {
        panelNumber: 1,
        title: 'THE GOTHIC THRESHOLD',
        narrationBox: 'BLACKWOOD CATACOMBS • 00:00 MIDNIGHT • OCCULT DISTURBANCE',
        thoughtMonologue: "The seal was shattered three hours ago. If the specter escapes these catacombs, the entire city falls into eternal twilight.",
        freezeFrameBadge: 'OCCULT DETECTIVE • PARANORMAL SPECIALIST',
        sceneEmoji: '🕯️ 🪦 🗝️',
        sceneDescription: 'Pushing open heavy gothic iron gates into the shadowy candelabra crypt...',
        bgGradient: 'linear-gradient(135deg, #2e1065 0%, #0a0319 100%)',
        accentColor: '#a855f7',
        soundEffect: '⚡ *CRRAAACK!*',
        sfxColor: '#c084fc',
        dialogues: [
          { speaker: 'hero', speakerName: 'DETECTIVE', avatar: '🧥', text: 'Spirit lantern burning bright. Let us banish whatever was awakened here.', tailPosition: 'left', emotion: 'determined' },
          { speaker: 'ally', speakerName: 'ARCHIVE COMMS', avatar: '📻', text: 'Detective! The tomb wardens are awakening across all three crypt halls!', tailPosition: 'right' },
        ],
        captionCards: [
          { text: "EVEN THOUGH THE ANCIENT GOTHIC SEALS WERE CRACKED ASUNDER,", position: 'top-left' },
          { text: "THE SPECTRAL WARDENS AND GHOULS SWARMED EVERY TOMB...", position: 'middle-right' },
          { text: "...AND HOW MY SPIRIT LANTERN CAN EXORCISE THE DARKENED CORRIDORS.", position: 'middle-right' },
        ],
      },
      {
        panelNumber: 2,
        title: 'THE WRAITH RISES',
        narrationBox: 'A SHADOWY WRAITH TOWERS OVER THE TOMBS WITH CHILLING VENGEANCE!',
        thoughtMonologue: "The spectral frost is creeping up my boots. No turning back. Time to raise the warding sigil.",
        freezeFrameBadge: 'SPECTRAL MENACE DETECTED',
        sceneEmoji: '👻 💥 🕯️',
        sceneDescription: 'Floating ethereal specters illuminate candelabras with purple witchfire!',
        bgGradient: 'linear-gradient(135deg, #4c0519 0%, #150106 100%)',
        accentColor: '#fb7185',
        soundEffect: '💥 *SLAAAM-KTOOM!*',
        sfxColor: '#f43f5e',
        dialogues: [
          { speaker: 'boss', speakerName: boss, avatar: '👻', text: 'MORTAL SOUL... THOU SHALT JOIN THE SLEEP OF THE DAMNED!', tailPosition: 'right', emotion: 'angry' },
          { speaker: 'hero', speakerName: 'DETECTIVE', avatar: '🔥', text: 'Not on my watch, ghost. This talisman burns with sacred fire!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "I SWORE TO CLEANSE THIS HAUNTED CRYPT OF DARKNESS.", position: 'top-left' },
          { text: "FROM THE CURSED PHANTOMS, THE SHADOWS, AND THE RESTLESS TOMBS...", position: 'middle-left' },
          { text: "I SWORE TO PROTECT THE LIVING FROM THE UNSEEN TERROR.", position: 'bottom-right' },
        ],
      },
      {
        panelNumber: 3,
        title: 'BREAK THE RUNESTONE CURSE',
        narrationBox: 'GATHER THE SILVER TALISMANS TO BANISH THE SHADOW ONCE AND FOR ALL!',
        thoughtMonologue: "Silver seals burning. Talismans charged. One leap across the abyss to seal the crypt forever.",
        freezeFrameBadge: 'MISSION OBJECTIVE: BREAK CURSE',
        sceneEmoji: '🗝️ 🕯️ 🏃',
        ...
        sfxColor: '#d8b4fe',
        dialogues: [
          { speaker: 'ally', speakerName: 'ARCHIVE COMMS', avatar: '📻', text: 'The silver seals break the specter grip! Seize them and break out!', tailPosition: 'right' },
          { speaker: 'hero', speakerName: 'DETECTIVE', avatar: '🏃', text: 'The dawn is coming! I am leaping through the iron gates!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "SILVER SEALS GLOWING THROUGH THE BLACK MIST. NO HESITATION.", position: 'top-left' },
          { text: "COMMS: THE PORTCULLIS IS SLAMMING SHUT! DIVE THROUGH NOW!", speaker: "ARCHIVE COMMS", position: 'middle-right' },
          { text: "HOLD THE DAWN GATE OPEN. I'M LEAPING OUT!", speaker: "OCCULT DETECTIVE", position: 'bottom-right' },
        ],
      },
    ],
  };
...
function generateCyberpunkStory(title: string, boss: string): ComicStory {
  return {
    title: 'THE NEURAL INFILTRATION',
    subtitle: `HOW YOU BROKE INTO ${title.toUpperCase()}`,
    theme: 'cyberpunk',
    universeTag: 'EARTH-2099-CYBER',
    heroCodename: 'CYBER-RUNNER',
    panels: [
      {
        panelNumber: 1,
        title: 'ICE FIREWALL INTRUSION',
        narrationBox: 'NEO-SHINJUKU SUBNET • LEVEL 99 • ICE FIREWALL MATRIX',
        thoughtMonologue: "Black-ICE firewalls flashing cyan. The megacorp thought their biometric vault was unbreachable.",
        freezeFrameBadge: 'CYBER-RUNNER • SUBNET INFILTRATOR',
        sceneEmoji: '🕶️ 💾 ⚡',
        sceneDescription: 'Siphoning encrypted corporate ledgers through a neural cyber-gauntlet...',
        bgGradient: 'linear-gradient(135deg, #051923 0%, #00080d 100%)',
        accentColor: '#00f2fe',
        soundEffect: '⚡ *BZZZZT!*',
        sfxColor: '#00f2fe',
        dialogues: [
          { speaker: 'hero', speakerName: 'RUNNER', avatar: '👾', text: 'Black-ICE protocols bypassed. Mainframe cipher in hand.', tailPosition: 'left', emotion: 'determined' },
          { speaker: 'ally', speakerName: 'DECK RIGGER', avatar: '🎧', text: 'Runner! The Chief Security Drone just launched the swarm!', tailPosition: 'right' },
        ],
        captionCards: [
          { text: "EVEN THOUGH THE MEGACORP SEALED EVERY TERMINAL WITH BLACK-ICE,", position: 'top-left' },
          { text: "AUTONOMOUS PURSUIT DRONES CONVERGED ON MY NEURAL LINK...", position: 'middle-right' },
          { text: "...AND HOW I MUST EXTRACT THE CIPHER BEFORE THE TRACE LOCKS ON.", position: 'middle-right' },
        ],
      },
      {
        panelNumber: 2,
        title: 'PURGE PROTOCOL INITIALIZED',
        narrationBox: 'A SHOCKWAVE OF CRIMSON COUNTERMEASURE CODE RIPS THROUGH FIBER!',
        thoughtMonologue: "Hunter drones deployed from the ceiling racks. Targeting lasers locking in. Adrenaline to maximum.",
        freezeFrameBadge: 'PURGE PROTOCOL INITIALIZED',
        sceneEmoji: '💥 🔴 🤖',
        sceneDescription: 'Autonomous drones decouple with blazing neon laser locks!',
        bgGradient: 'linear-gradient(135deg, #450a0a 0%, #150202 100%)',
        accentColor: '#ff0055',
        ...
        dialogues: [
          ...
          { speaker: 'hero', speakerName: 'RUNNER', avatar: '⚡', text: 'Try catching lightning, scrap-metal! My EMP gauntlet is armed!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "I SWORE TO BRING THE MEGACORP CONSPIRACY TO ITS KNEES.", position: 'top-left' },
          { text: "FROM THE CORRUPT EXECS, THE DRONE SWARMS, AND THE TRACE NETS...", position: 'middle-left' },
          { text: "I SWORE TO FREE THE CITIZENS FROM SYNTHETIC TYRANNY.", position: 'bottom-right' },
        ],
      },
      {
        panelNumber: 3,
        title: 'OVERCLOCK AND PURGE',
        narrationBox: 'HACK THE SERVER TERMINALS TO BLOW THE SKYWAY AIRLOCK!',
        thoughtMonologue: "Overclocking neural thrusters. 200 stories above neon avenues. Time for a leap of faith.",
        freezeFrameBadge: 'LEAP OF FAITH • SKYWAY AIRLOCK',
        sceneEmoji: '🏃 🚀 ⚡',
        sceneDescription: 'Sprinting across the holographic glass skyway toward extraction!',
        bgGradient: 'linear-gradient(135deg, #091e3a 0%, #020710 100%)',
        accentColor: '#00f2fe',
        soundEffect: '💥 *SHOCKWAVE-BOOM!*',
        sfxColor: '#00f2fe',
        dialogues: [
          { speaker: 'ally', speakerName: 'DECK RIGGER', avatar: '🎧', text: 'Runner! The aerocar is hovering outside the 90th floor glass! JUMP!', tailPosition: 'right' },
          { speaker: 'hero', speakerName: 'RUNNER', avatar: '⚡', text: 'Catch me on the flip side, partner! Dropping in!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "NEURAL OVERCLOCK PEAKING AT 120 PERCENT. NO SECOND ATTEMPTS.", position: 'top-left' },
          { text: "RIGGER: THE AEROCAR IS AT THE LEDGE! SHATTER THE GLASS AND JUMP!", speaker: "DECK RIGGER", position: 'middle-right' },
          { text: "PREPARE THE EXTRACTION CODES. I'M DIVING OFF THE SPIRE!", speaker: "CYBER-RUNNER", position: 'bottom-right' },
        ],
      },
    ],
  };
...
function generateSpaceStory(title: string, boss: string): ComicStory {
  return {
    title: 'THE VOID OUTPOST BREACH',
    subtitle: `HOW YOU WERE STRANDED ON ${title.toUpperCase()}`,
    theme: 'space',
    universeTag: 'EARTH-COSMIC-99',
    heroCodename: 'VOID OPERATIVE',
    panels: [
      {
        panelNumber: 1,
        title: 'ORBITAL MAINTENANCE RUN',
        narrationBox: 'OUTER KUIPER STATION • ZERO GRAVITY • DEEP COSMIC NIGHT',
        thoughtMonologue: "Zero gravity. The alien bio-swarm breached the primary airlock. Life support is dropping by the minute.",
        freezeFrameBadge: 'VOID OPERATIVE • STATION SPECIALIST',
        sceneEmoji: '🚀 👨‍🚀 ✨',
        ...
        sfxColor: '#c084fc',
        dialogues: [
          { speaker: 'hero', speakerName: 'VOID OPERATIVE', avatar: '👨‍🚀', text: 'Thrusters calibrated. I need to reach the escape pod before the hull collapses.', tailPosition: 'left', emotion: 'determined' },
        ...
        captionCards: [
          { text: "EVEN THOUGH THE MOTHERSHIP HULL WAS RIPPED BY MICROMETEORS,", position: 'top-left' },
          { text: "THE ALIEN SENTINELS SWARMED THE AIRLOCK GANTRIES...", position: 'middle-right' },
          { text: "...AND HOW MY THRUSTER PACK CAN BLAST ME TO THE RESCUE POD.", position: 'middle-right' },
        ],
      },
      {
        panelNumber: 2,
        ...
        thoughtMonologue: "Outer airlock depressurized. Swarm drones locking lasers. My suit's oxygen is at forty percent.",
        ...
        dialogues: [
          ...
          { speaker: 'hero', speakerName: 'VOID OPERATIVE', avatar: '🔥', text: 'Not while I can still fire my plasma thrusters!', tailPosition: 'left', emotion: 'determined' },
        ],
        captionCards: [
          { text: "I SWORE TO SURVIVE THIS ZERO-G VOID AND PROTECT THE DATA CACHE.", position: 'top-left' },
          { text: "FROM THE SWARMING HORRORS, THE DEPRESSURIZATION, AND THE LASERS...", position: 'middle-left' },
          { text: "I SWORE TO BRING THE STAR MAPS BACK TO PLANET EARTH.", position: 'bottom-right' },
        ],
      },
      {
        panelNumber: 3,
        ...
        thoughtMonologue: "Zero gravity. Overheated thrusters. One chance to jump into hyperspace. Leap of faith.",
        ...
        sfxColor: '#38bdf8',
        dialogues: [
          { speaker: 'hero', speakerName: 'VOID OPERATIVE', avatar: '🔥', text: 'Thrusters primed! Punching into hyper-space NOW!', tailPosition: 'left', emotion: 'determined' },
          { speaker: 'boss', speakerName: boss, avatar: '👾', text: 'SEAL ALL BULKHEADS! DO NOT LET THE HUMAN REACH THE ENGINES!', tailPosition: 'right' },
        ],
        captionCards: [
          { text: "HYPER-DRIVE SPOOLING TO 100 PERCENT. ZERO GRAVITY ESCAPE.", position: 'top-left' },
          { text: "AI: AIRLOCK SEAL FAILED! REACH THE WARP SHUTTLE IN 60 SECONDS!", speaker: "AI MOTHER", position: 'middle-right' },
          { text: "PRIMING THRUSTERS. I'M LEAPING INTO THE VOID!", speaker: "VOID OPERATIVE", position: 'bottom-right' },
        ],
      },
    ],
  };
